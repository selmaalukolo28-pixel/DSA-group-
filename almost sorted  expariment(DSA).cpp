...
public class Main {
    ...
    public static int[] createAlmostSortedArray() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("===== ALMOST SORTED ARRAY TEST =====");

        int[] almostSorted = createAlmostSortedArray();

        test(almostSorted, 100);
    }
}
